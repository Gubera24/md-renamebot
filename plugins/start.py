   ...
   await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
             [[
               ...
               InlineKeyboardButton('📢 Update Channel', url='https://t.me/+DvjxoCNOLqxhOTNl'),
               InlineKeyboardButton('👻 Horror Channel', url='https://t.me/Tamilan224')
             ],[
                InlineKeyboardButton('📃 Source code', url='https://github.com/Gubera24/md-renamebot')
             ]]
   ))
